<?php
  ...
  $url = "http://api.steampowered.com/ISteamUser/GetPlayerSummaries/v0002/?key=CE47929DD4D516D66A3DDC0A37117A6D" . $SteamAPIKey . "&steamids=2059690690" . $userID;
      ...
      <div class="section hide-on-med-and-down"><br><br><br><br>
        <div class="row">
          <div class="col s6">
            ...
            <div class="card-panel hoverable <?php echo $materialize_card_color; ?> waves-effect waves-block waves-<?php echo $materialize_waves_color; ?> bigEntrance">
              <h5 class="center-align bigEntrance"><i class="material-icons mi-valign">description</i>&nbsp;&nbsp;&nbsp;Правила 1<h5>
              <ol class="bigEntrance" style="font-size:18px" type="1">
                <?php echo $Правила сервера 2; ?>
              </ol>
            </div>
          </div>
          <div class="col s6">
